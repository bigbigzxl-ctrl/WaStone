/*
 * STM32F103RCT6 — PB8/PB9 PWM capture mailbox test
 *
 * Observable behaviour:
 *   - PB8 drives a software PWM waveform
 *   - PB9 samples the looped-back waveform
 *   - TIM2 free-runs at 1 MHz to measure high time and period
 *   - PASS when duty and period stay inside the expected windows
 *   - detail0 = ((period_us << 16) | high_us)
 *
...
#define ERR_SYNC_TIMEOUT  0xC201U
#define ERR_EDGE_TIMEOUT  0xC202U
#define ERR_PERIOD_RANGE  0xC203U
#define ERR_DUTY_RANGE    0xC204U
...
int main(void)
{
    ...
    AEL_MAILBOX->detail0 = (period_us << 16) | (high_us & 0xFFFFU);

    if (period_us < 800U || period_us > 1300U) {
