...
#define ERR_HIGH_MISS 0xE801u
#define ERR_LOW_MISS  0xE802u
...
int main(void)
{
    ...
    /*
     * PC8: output push-pull 2 MHz -> CRH[3:0] = 0x2
     * PC9: input pull-down        -> CRH[7:4] = 0x8, ODR9 = 0
     */
    GPIOC_CRH &= ~0xFFu;
    GPIOC_CRH |=  0x82u;
    GPIOC_ODR &= ~((1u << 8u) | (1u << 9u));
