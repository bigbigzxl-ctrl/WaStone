/* ch32v305_spi_dma — SPI1 master loopback via DMA
 * Board: CH32V305RBT6
 * Wiring: PA7 ↔ PA6 jumper (MOSI ↔ MISO)
 * Clock: 96 MHz; APB2=96MHz; SPI1 /64 ≈ 1.5 MHz
 *
 * DMA1_Ch2 = SPI1_RX (peripheral→memory)
 * DMA1_Ch3 = SPI1_TX (memory→peripheral)
 * Start RX first, then TX. Wait both TC flags. Compare.
 */
